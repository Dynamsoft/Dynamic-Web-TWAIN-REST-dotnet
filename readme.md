...
* **DocumentViewer.JSInterop**: a package to help you integrate document capturing with a dedicated viewer in your .NET app using WebView with extra features like PDF loading and saving. It is using a dedicated web document viewer: [Dynamsoft Document Viewer](https://www.dynamsoft.com/document-viewer/overview/).
