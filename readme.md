...
* **DynamicWebTWAIN.Service**: a package to help you embed [Dynamic Web TWAIN service](https://www.dynamsoft.com/web-twain/docs/core-concepts/Dynamic-Web-TWAIN-Service.html) in your app without the need to use its installer. The service is used to access document scanners and provide the REST API for document scanning.
